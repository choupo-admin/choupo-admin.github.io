...
`,G=Object.assign({"../../../data/standards/parameters/NRTL/benzene-toluene.dat":L,"../../../data/standards/parameters/NRTL/ethanol-water.dat":F}),K=Object.assign({}),z=Object.assign({"../../../data/standards/parameters/UNIQUAC/aceticAcid-methylAcetate.dat":R,"../../../data/standards/parameters/UNIQUAC/methanol-methylAcetate.dat":B,"../../../data/standards/parameters/UNIQUAC/methylAcetate-water.dat":V});function C(t,e){const n=[];for(const o of Object.values(t))try{const i=j(_(o)).components;Array.isArray(i)&&i.length===2&&n.push({model:e,a:String(i[0]),b:String(i[1])})}catch{}return n}const $=[...C(G,"NRTL"),...C(K,"Wilson"),...C(z,"UNIQUAC")];function ct(t,e,n){return $.some(o=>o.model===t&&(o.a===e&&o.b===n||o.a===n&&o.b===e))}export{N as B,h as E,X as I,Z as a,st as b,ot as c,U as d,S as e,it as f,Y as g,ct as h,rt as i,et as j,lt as k,tt as m,I as o,nt as p,at as s,E as u};

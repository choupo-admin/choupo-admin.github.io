import{ae as Ye,bc as Qe,aS as Ze,bp as Se,aJ as e,aK as tn,aQ as cn,bf as Aa,b9 as gn,b2 as d,a as qn,W as vn,G as x,B as bn,at as se,Z as S,a_ as fn,V as Ue,a0 as en,d as En,q as ia,_ as Ha,f as de,U as yt,c as nn,a3 as ra,g as Tt,i as vt,y as Pt,Q as R,A as Pe,L as ze,X as D,al as St,o as Ot,b5 as _a,b8 as At,av as Ht,aW as Gn,aU as Le,R as ce,p as _t,h as Et,bn as wt,l as Nt,m as xt,k as Rt}from"./index-DDdEt6DK.js";import{b as kt,d as Mt}from"./CsvAutoPlot-BI2lWlTZ.js";import{G as Kt}from"./GibbsMapPanel-DHDih8h0.js";import{P as J,e as rn,c as Xe,a as no}from"./plotly-Cy3GrnOZ.js";import{S as sa,p as qt,M as It}from"./exploreMccabePopOut-DbSK-tHP.js";import{S as Ao}from"./Slider-B0YSkHQl.js";import{S as Tn}from"./Select-k0tGAB21.js";import{C as Eo}from"./Collapse-BtYm9huv.js";import{D as la}from"./Divider-DZHerpKq.js";import{C as Jt}from"./CopyButton-BtVLCqyR.js";import"./InputsGroupFieldset-Dk0g7yLl.js";/**
...
//
// K_f IS REFERENCE-ONLY (2026-08-06).  It is parsed and NOTHING CONSUMES IT:
// no unit operation in Choupo models freezing-point depression, and the
// parallel derivation K_f = R*Tf^2*M/dHfus cannot run because no record in
// the tree declares a heat of fusion (\`Hfus\` is parsed only inside a
// \`sublimation {}\` block, which water does not carry).  The number is kept
// because it is right and curated; its STATUS is written down because a datum
// the engine reads and never uses is otherwise indistinguishable from a
// capability.  \`check_ebullioscopic\` asserts it stays unconsumed, so wiring it
// up forces this note to be rewritten rather than quietly outlived.
ebulioscopic
{
    K_b   0.512;
    K_f   1.853;    // reference-only -- see the note above
}
